<nav id="sidebar">
    ...
    <div class="sidebar_blog_2">
        ...
        <ul class="list-unstyled components">
            ...
            <li><a href="category.php"><i class="fa fa-clock-o orange_color"></i> <span>Quản lý danh mục</span></a></li>
            <li><a href="posts.php"><i class="fa fa-clock-o orange_color"></i> <span>Quản lý bài viết</span></a></li>
            <li><a href="widgets.html"><i class="fa fa-clock-o orange_color"></i> <span>Quản lý hình ảnh</span></a></li>
            <li><a href="widgets.html"><i class="fa fa-clock-o orange_color"></i> <span>Quản lý đơn hàng</span></a></li>
            <li>
